<template>
	<div class="mbc-page page--thank-you">
		<banner title="We will reach out shortly" preTitle="Thank You" />
		<div class="mbc-wrapper text-center flex flex-col justify-center items-center">
			...
			<h1 class="text-2xl text-center">We appreciate you filling out our form, and our experts will respond to you soon.</h1>
			<button aria-label="Return Home" class="mbc-button mt-8 text-center" @click="$router.push('/')"><i class="fa fa-home mr-2"></i>Return Home</button>
		</div>
  	</div>
</template>
